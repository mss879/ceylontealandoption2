        ...
        <section className="bg-[#f4f1ea] py-20 lg:py-28 border-b border-[#ead9bc]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-6 text-lg text-neutral-600 leading-relaxed">
              <p>
                Green tea in Sri Lanka is a relatively recent addition to the island&apos;s celebrated tea portfolio, but it has rapidly gained international recognition for its exceptional purity and distinct flavour profile. Unlike the deeply oxidised <Link href="/our-tea/black-tea" className="underline decoration-emerald-700/40 hover:decoration-emerald-700 transition-colors font-medium">black teas that Sri Lanka is famous for</Link>, Ceylon green tea undergoes minimal oxidation — typically less than 5% — preserving the leaf&apos;s natural antioxidants, bright colour, and delicate vegetal notes.
              </p>
              <p>
              ...
              <p>
                Explore our full range of teas — including <Link href="/our-tea/black-tea" className="underline decoration-emerald-700/40 hover:decoration-emerald-700 transition-colors font-medium">premium black tea from Sri Lanka</Link> and <Link href="/our-tea/flavoured-tea" className="underline decoration-emerald-700/40 hover:decoration-emerald-700 transition-colors font-medium">aromatic flavoured tea blends</Link> — or <Link href="/contact" className="underline decoration-emerald-700/40 hover:decoration-emerald-700 transition-colors font-medium">contact our team</Link> to request samples and wholesale pricing.
              </p>
            </div>
          </div>
        </section>
