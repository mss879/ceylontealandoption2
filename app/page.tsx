            ...
            <div className="border border-[#ead9bc] rounded-3xl overflow-hidden shadow-[0_35px_80px_rgba(137,101,46,0.08)] bg-white/70 backdrop-blur">
              <div className="grid gap-12 p-10 lg:grid-cols-[1.25fr_1fr] lg:p-14">
                ...
                <div className="space-y-6 text-base leading-relaxed text-neutral-600">
                  ...
                  <p>
                    Explore our <Link href="/our-tea/black-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors">premium black tea grades</Link>, <Link href="/our-tea/green-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors">pure green tea from Sri Lanka</Link>, and <Link href="/our-tea/flavoured-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors">aromatic flavoured tea blends</Link> — and experience the difference that generations of
            ...
            <div className="grid lg:grid-cols-[1.2fr_1fr] gap-16 lg:gap-20 items-start">
              <div className="space-y-8">
                ...
                <div className="space-y-5 text-lg text-neutral-600 leading-relaxed text-justify">
                  ...
                  <p>
                    Our export portfolio includes <Link href="/our-tea/black-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors font-medium">premium black tea grades</Link> (BOP, BOPF, OP, Pekoe), <Link href="/our-tea/green-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors font-medium">pure Ceylon green tea</Link>, and <Link href="/our-tea/flavoured-tea" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors font-medium">aromatic flavoured blends</Link>. We export in all formats, including bulk loose leaf in moisture-barrier sacks, retail-ready tea bags (string &amp; tag and pyramid), and fully branded consumer packs via our <Link href="/branding" className="underline decoration-[#b58b54]/40 hover:decoration-[#b58b54] transition-colors font-medium">private label tea branding service</Link>.
                  </p>
                </div>
              </div>
